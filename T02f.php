                ...
                <div style="width:500px" class="main-login-form">
                    <div class="login-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pr_nome" name="pr_nome" placeholder="Nome" maxlength="50" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pr_rua" name="pr_rua" placeholder="Logradouro" maxlength="60" required />
                        </div>
                        <div class="form-group">
                            <label for="pr_comp" class="sr-only">Complemento</label>
                            <input type="text" class="form-control" id="pr_comp" name="pr_comp" placeholder="Complemento" maxlength="60" required />
                        </div>
                        <div class="form-group">
                            <label for="pr_num" class="sr-only">Número</label>
                            <input type="text" class="form-control" id="pr_num" name="pr_num" placeholder="Número" maxlength="10" required />
                        </div>
                        <div class="form-group">
                            <label for="pr_bairro" class="sr-only">Bairro</label>
                            <input type="text" class="form-control" id="pr_bairro" name="pr_bairro" placeholder="Bairro" maxlength="40" required />
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pr_city" name="pr_city" placeholder="   Cidade" maxlength="50" required />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-3">
