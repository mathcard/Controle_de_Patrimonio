                ...
                <div style="width:500px" class="main-login-form">
                    <div class="login-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ct_nome" name="ct_nome" maxlength="50" placeholder="Nome" required />
                        </div>
                        <div class="form-group">
                            <label for="ct_desc" class="sr-only">Descrição</label>
                            <textarea type="text" class="form-control" id="ct_desc" name="ct_desc" placeholder="Descrição" maxlength="400" required /></textarea>
                        </div>
                        <div class="form-group">
