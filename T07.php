                ...
                <div style="width:500px" class="main-login-form">
                    <div class="login-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="selbem" name="selbem" title='Bem' onChange="javascript: buscarSala();">  
                                    <option>Bem</option> 
                                    </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="selsalao" name="selsalao" onChange="javascript: buscarSalas();">
