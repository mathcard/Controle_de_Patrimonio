...
?>
    ...
    $nome = $_GET['nome'];
    $sql= "SELECT numero,bempatrimonial.descricao as descricao,datacompra,prazogarantia,nrnotafiscal,fornecedor,valor,situacao,codcategoria,numsala,categoria.descricao as catdesc, round(valor/vidautil, 2) as depre FROM bempatrimonial,categoria WHERE upper(descricao) LIKE upper(:nome)" . $ordem;
    ...
    while ($row = $resultado->fetchObject()) {
		 ...
		 <a href='baixa.php?id=$id'>
            ...
            $sql= "SELECT numero,bempatrimonial.descricao as descricao,datacompra,prazogarantia,nrnotafiscal,fornecedor,valor,situacao,codcategoria,numsala,categoria.descricao as catdesc, round(valor/vidautil, 2) as depre FROM bempatrimonial,categoria WHERE bempatrimonial.codcategoria=categoria.codigo" . $ordem;
            $resultado = $con->prepare($sql);
            $resultado->execute();
            #$total = $resultado->rowCount();
